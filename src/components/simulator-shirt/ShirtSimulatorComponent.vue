        ...
        <template #end>
            <layout-main-body relative>
                <layout-header>
                    ...
                    <template #title>シャツ - 長袖</template>
                </layout-header>
                ...
                <absolute-loading v-if="false" />
                <transition name="right">
                    <option-item-select
                        v-if="selectedOptionCategoryId"
...
<script>
import { useShirtSimulator } from '@/store/simu/shirt'
